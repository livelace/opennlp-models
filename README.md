...
```bash
user@localhost ~ $ docker run -ti --rm ghcr.io/livelace/opennlp-models:1.9.2
...
docker run -ti --rm ghcr.io/livelace/opennlp-models:1.9.2 --type news --lang ru --entity all
...
```bash
user@localhost ~ $ docker run -ti --rm ghcr.io/livelace/opennlp-models:1.9.2 --type news --lang ru --entity all
INFO: Type here: 
